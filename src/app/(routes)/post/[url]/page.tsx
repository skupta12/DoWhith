    ...
    >
      ...
      <MaxWidthWrapper className="max-w-[990px]">
        ...
        <div className="bg-white md:p-8 p-4 rounded-2xl flex flex-col">
          ...
          <div className="author-block flex md:flex-row flex-col gap-y-4 justify-between py-8">
          ...
          <div className="post-details-block">
            ...
            <div className="flex flex-col gap-y-4 mb-10">
              ...
              <blockquote className="sm:text-[24px] text-[20px] font-medium text-gray-400 relative pl-10">
                <span className="absolute top-0 left-0 h-full w-[6px] bg-primary-300" />
              ...
              <p className={styles.paragraph100}>
                ...
                and more. For example, remote learning apps can share courseware
                with students, or use chat to assign work. Companies that
                aren&apos;t allowing users to connect with modern chat
                functionality are missing out on longer session times, higher
                engagement rates, and ultimately – revenue.
              </p>
              <p className={styles.paragraph100}>
                There are many different software applications available to
                assist with task tracking. Some are designed for personal use,
                while others are intended for businesses and teams. There is no
                one “best” way to track tasks; the best solution will vary
          ...
          <div className="post-details-block">
            ...
            <div className="flex flex-col gap-y-4 mb-10">
            <p className={styles.paragraph100}>Real human-to-human conversation is more than an exchange of sentences. Allow users to connect with each other by sharing thoughts, feelings, information, and more.</p>
            <ul className="list-inside list-disc">
              <li className={styles.paragraph100}>Improve overall in-app retention and conversions by supplementing digital conversations with modern chat features like message reactions, message threading, typing indicators, and more.</li>
              <li className={styles.paragraph100}>These simple ways of communication are easier than writing out full messages and reduce friction in the user experience. This will empower users to engage and connect through more meaningful conversations.</li>
            </ul>
            </div>
