  ...
  return (
    <section className={styles.sectionPadding}>
      <MaxWidthWrapper>
        ...
        <div className="grid grid-cols-12 gap-y-14 sm:gap-x-12 gap-x-0 lg:text-start text-center">
          {exploreFeatures.map((item, i) => (
            <div
              key={i}
              className="lg:col-span-4 sm:col-span-6 col-span-12 flex flex-col gap-y-4"
            >
              <Image className="mb-2" src={item.icon} alt={item.alt} width={48} height={48} />
